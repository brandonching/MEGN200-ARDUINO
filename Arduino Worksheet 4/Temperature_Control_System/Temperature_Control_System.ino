...
int threshold = 32; // initialize temp temperature threshold trigger variable, may need to adjust this for your hand temperature
...
void loop() { // runs continuously as long as the Arduino has power
  ...
  // if statement which turns the motor on (set motor speed and a direction) and the servo angle to 90 degrees

  // else statement which turns the motor off and the servo angle to 0 degrees
